...
if __name__ == "__main__":
    ...
    argparser.add_argument("--input-file", type=str, default="orders_data.json", help="Input json file")
    argparser.add_argument("--output-file", type=str, default="orders_data_transcript.json", help="Output json file")
